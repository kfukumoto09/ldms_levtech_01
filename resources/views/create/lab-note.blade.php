<x-app-layout>
    ...
    <div class='py-2'>
        ...
        <p class='text-sm'>Created at {{ $subject->created_at }}</p>
        <p class='text-sm'>Updated at {{ $subject->updated_at }}</p>
    </div>
    ...
    <div class="py-2">
        <form id="create", action="/create/note/subject-{{ $subject->id }}" method="POST" class="row">
            ...
            <div class="relative">
              ...
              <input datepicker datepicker-autohide type="text" datepicker-format="yyyy-mm-dd" id='date' name='lab_note[performed_on]' class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
            </div>
            <!--<div class='py-2'>-->
            <!--    <label for='date'><h2>Date</h2></label>-->
            <!--    <div inline-datepicker data-date="{{ date('yyyy-mm-dd') }}" id='date' name='lab_note[performed_on]'></div>-->
            <!--</div>-->
